...
| Token                    | Hex       | Usage                     |
| ------------------------ | --------- | ------------------------- |
| `color-accent-primary`   | `#C24911` | Active value / state      |
| `color-accent-muted`     | `#F5B59B` | Secondary emphasis        |
| `color-accent-indicator` | `#C24911` | Scroll position indicator |
