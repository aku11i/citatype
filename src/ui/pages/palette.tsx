...
const warmCandidates: ColorCandidate[] = [
  currentAccent,
...
const coolCandidates: ColorCandidate[] = [
...
const sections: Array<{
  title: "palette.groupWarm" | "palette.groupCool";
  items: ColorCandidate[];
}> = [
  { title: "palette.groupWarm", items: warmCandidates },
  { title: "palette.groupCool", items: coolCandidates },
];
